          ...
          <div className="flex flex-wrap items-end gap-4">
            ...
            <div className="flex-1 min-w-[200px]">
              ...
              <input
                ...
                placeholder="e.g., Includes cover, trailer prep, free delivery"
            ...
            {hasDiscount && (
              <div className="flex-shrink-0 bg-green-50 border border-green-200 rounded-lg px-4 py-2">
                <div className="text-xs text-green-600 font-medium">Sale Price</div>
                <div className="text-xl font-bold text-green-700">{formatPrice(salePrice)}</div>
              </div>
            )}
          </div>
        </div>
